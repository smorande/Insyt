...
- WORD COUNT: EXACTLY 500-800 words (STRICTLY ENFORCED)
...
- Key Market Insights (120-150 words) 
- Financial Highlights (100-120 words)
- Strategic Recommendations (100-120 words)
- Risk Assessment (80-100 words)
- Immediate Action Items (50-80 words)
...
class MultiAgentResearchOrchestrator:
    ...
    *[100-150 words: Next steps and execution timeline]*
    ...
    Use professional formatting with clear sections, bullet points for key insights, and strategic depth. Target exactly 1250 words.
    """
